...
/**
 */
class PersonaViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	 ...
	 * @return string
	 */
	public function render($as = 'persona') {
		...
		$this->templateVariableContainer->add($as, $persona);
